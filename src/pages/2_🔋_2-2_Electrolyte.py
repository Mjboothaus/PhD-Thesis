...
def set_fluid_parameters(name):
    ...
    if name == "kcl":
        ...
        parameters = dict({"name": "H_2O", "component": ["H", "O"], "valence": np.array([
         ...
         parameters = dict({"name": "2_2_electrolyte", "component": ["2+", "2-"], "valence": np.array([
                        2.0, -2.0]), "temperature": 298.15, "concentration": np.array([0.5, 0.5]),
            "epsilon_r": 78.358})       
...
fluid = set_fluid_parameters("2_2")
